class RostersController < ApplicationController
  ...
  private
    ...
    def roster_params
      params.require(:roster).permit(:stats_inc_id, :team_id, :playerstats_id, :first, :last, :num, :pos, :import_status, :height, :weight, :birthdate, :birthplace, :college, :yrsteam, :yrsleague, :ros_status)
    end
end
